...
@interface MSGraphOAuth2Permission : MSObject
...
@property (nonnull, nonatomic, setter=setOAuth2PermissionId:, getter=oAuth2PermissionId) NSString* oAuth2PermissionId;

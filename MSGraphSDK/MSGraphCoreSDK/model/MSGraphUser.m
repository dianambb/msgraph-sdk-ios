...
- (NSArray*) joinedGroups
{
    ...
    NSMutableArray *joinedGroupsResult = [NSMutableArray array];
    NSArray *joinedGroups = self.dictionary[@"joinedGroups"];

    if ([joinedGroups isKindOfClass:[NSArray class]]){
        for (id group in joinedGroups){
            [joinedGroupsResult addObject:[[MSGraphGroup alloc] initWithDictionary: group]];
        }
    }

    _joinedGroups = joinedGroupsResult;
        
    }
    return _joinedGroups;
}

- (void) setJoinedGroups: (NSArray*) val
{
    _joinedGroups = val;
    self.dictionary[@"joinedGroups"] = val;
}
...
- (NSArray*) trendingAround
{
    if(!_trendingAround){
        
    NSMutableArray *trendingAroundResult = [NSMutableArray array];
    NSArray *trendingAround = self.dictionary[@"trendingAround"];

    if ([trendingAround isKindOfClass:[NSArray class]]){
        for (id driveItem in trendingAround){
            [trendingAroundResult addObject:[[MSGraphDriveItem alloc] initWithDictionary: driveItem]];
        }
    }

    _trendingAround = trendingAroundResult;
        
    }
    return _trendingAround;
}

- (void) setTrendingAround: (NSArray*) val
{
    _trendingAround = val;
    self.dictionary[@"trendingAround"] = val;
}
...
- (NSArray*) workingWith
{
    ...
    NSMutableArray *workingWithResult = [NSMutableArray array];
    NSArray *workingWith = self.dictionary[@"workingWith"];

    if ([workingWith isKindOfClass:[NSArray class]]){
        for (id user in workingWith){
            [workingWithResult addObject:[[MSGraphUser alloc] initWithDictionary: user]];
        }
    }

    _workingWith = workingWithResult;
        
    }
    return _workingWith;
}

- (void) setWorkingWith: (NSArray*) val
{
    _workingWith = val;
    self.dictionary[@"workingWith"] = val;
}

...
@interface MSGraphDirectorySetting()
{
...
@implementation MSGraphDirectorySetting

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.directorySetting";
    }
    return self;
}
...
- (NSArray*) values
{
    ...
    if ([values isKindOfClass:[NSArray class]]){
        for (id settingValue in values){
            [valuesResult addObject:[[MSGraphSettingValue alloc] initWithDictionary: settingValue]];
        }
    }

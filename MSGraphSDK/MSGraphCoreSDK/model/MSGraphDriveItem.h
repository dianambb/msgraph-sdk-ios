...
@class MSGraphIdentitySet, MSGraphItemReference, MSGraphAudio, MSGraphDeleted, MSGraphFile, MSGraphFileSystemInfo, MSGraphFolder, MSGraphImage, MSGraphGeoCoordinates, MSGraphPhoto, MSGraphRemoteItem, MSGraphSearchResult, MSGraphShared, MSGraphSpecialFolder, MSGraphVideo, MSGraphPackage, MSGraphWorkbook, MSGraphUser, MSGraphPermission, MSGraphThumbnailSet; 

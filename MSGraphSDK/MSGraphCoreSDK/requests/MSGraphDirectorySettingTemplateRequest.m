...
@implementation MSGraphDirectorySettingTemplateRequest
...
- (NSMutableURLRequest *)update:(MSGraphDirectorySettingTemplate *)directorySettingTemplate
{    
    NSData *body = [NSJSONSerialization dataWithJSONObject:[directorySettingTemplate dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:directorySettingTemplate]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDirectorySettingTemplate alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

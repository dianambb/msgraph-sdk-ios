...
@implementation MSGraphTaskBoardTaskFormatRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphTaskBoardTaskFormat *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTaskBoardTaskFormat alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:taskBoardTaskFormat]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTaskBoardTaskFormat alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

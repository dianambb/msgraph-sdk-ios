...
@implementation MSGraphDirectorySettingRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphDirectorySetting *response, NSError *error))completionHandler
{
...
- (MSURLSessionDataTask *)update:(MSGraphDirectorySetting *)directorySetting withCompletion:(void (^)(MSGraphDirectorySetting *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:directorySetting]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDirectorySetting alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

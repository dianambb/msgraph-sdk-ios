...
@implementation MSGraphTasksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphTasksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphTasksCollectionRequest *nextRequest = [[MSGraphTasksCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[task dictionaryFromItem]
                                                   options:0
                                                     error:nil];

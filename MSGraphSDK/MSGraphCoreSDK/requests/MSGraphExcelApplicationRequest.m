...
@implementation MSGraphExcelApplicationRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphExcelApplication *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphExcelApplication alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:excelApplication]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphExcelApplication alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

...
@implementation MSGraphAnonymousIpRiskEventRequest
...
- (NSMutableURLRequest *)update:(MSGraphAnonymousIpRiskEvent *)anonymousIpRiskEvent
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[anonymousIpRiskEvent dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:anonymousIpRiskEvent]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphAnonymousIpRiskEvent alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

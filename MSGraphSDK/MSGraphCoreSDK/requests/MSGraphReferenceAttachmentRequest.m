...
@implementation MSGraphReferenceAttachmentRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphReferenceAttachment *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphReferenceAttachment alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:referenceAttachment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphReferenceAttachment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

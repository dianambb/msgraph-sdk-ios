...
@implementation MSGraphServicePrincipalOwnedObjectsCollectionWithReferencesRequestBuilder : MSCollectionRequestBuilder
...
{
    return [[MSGraphServicePrincipalOwnedObjectsCollectionWithReferencesRequest alloc] initWithURL:self.requestURL options:options client:self.client];
}
...
{
    return [[MSGraphServicePrincipalOwnedObjectsCollectionReferencesRequestBuilder alloc] initWithURL:[self.requestURL URLByAppendingPathComponent:@"$ref"] client:self.client];
}

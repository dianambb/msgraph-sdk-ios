...
@implementation MSGraphUserTrendingAroundCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserTrendingAroundCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserTrendingAroundCollectionRequest *nextRequest = [[MSGraphUserTrendingAroundCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];

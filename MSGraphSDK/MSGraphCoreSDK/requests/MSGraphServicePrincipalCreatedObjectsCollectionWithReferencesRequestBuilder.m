...
@implementation MSGraphServicePrincipalCreatedObjectsCollectionWithReferencesRequestBuilder : MSCollectionRequestBuilder
...
{
    return [[MSGraphServicePrincipalCreatedObjectsCollectionWithReferencesRequest alloc] initWithURL:self.requestURL options:options client:self.client];
}
...
{
    return [[MSGraphServicePrincipalCreatedObjectsCollectionReferencesRequestBuilder alloc] initWithURL:[self.requestURL URLByAppendingPathComponent:@"$ref"] client:self.client];
}

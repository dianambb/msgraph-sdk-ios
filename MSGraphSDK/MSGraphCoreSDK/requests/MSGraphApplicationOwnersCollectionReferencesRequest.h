...
typedef void (^MSGraphApplicationOwnersCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphApplicationOwnersCollectionReferencesRequest *nextRequest, NSError *error);

@interface MSGraphApplicationOwnersCollectionReferencesRequest : MSCollectionRequest

...
@implementation MSGraphOrganizationRequest
...
- (NSMutableURLRequest *)update:(MSGraphOrganization *)organization
{    
    NSData *body = [NSJSONSerialization dataWithJSONObject:[organization dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:organization]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOrganization alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

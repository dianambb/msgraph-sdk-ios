...
@implementation MSGraphNotebookRequest
...
- (NSMutableURLRequest *)update:(MSGraphNotebook *)notebook
{    
    NSData *body = [NSJSONSerialization dataWithJSONObject:[notebook dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:notebook]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphNotebook alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

...
@interface MSGraphFilterApplyValuesFilterRequest()
...
@implementation MSGraphFilterApplyValuesFilterRequest


- (instancetype)initWithValues:(MSGraphJson *)values URL:(NSURL *)url options:(NSArray *)options client:(ODataBaseClient*)client
{

...
@implementation MSGraphSingleValueLegacyExtendedPropertyRequest
...
- (NSMutableURLRequest *)update:(MSGraphSingleValueLegacyExtendedProperty *)singleValueLegacyExtendedProperty
{    
    NSData *body = [NSJSONSerialization dataWithJSONObject:[singleValueLegacyExtendedProperty dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:singleValueLegacyExtendedProperty]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphSingleValueLegacyExtendedProperty alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

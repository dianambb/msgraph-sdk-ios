...
@implementation MSGraphServicePrincipalRequest
...
- (NSMutableURLRequest *)update:(MSGraphServicePrincipal *)servicePrincipal
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[servicePrincipal dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:servicePrincipal]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphServicePrincipal alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

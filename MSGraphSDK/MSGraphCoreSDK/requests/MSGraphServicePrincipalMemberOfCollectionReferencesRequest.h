...
typedef void (^MSGraphServicePrincipalMemberOfCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphServicePrincipalMemberOfCollectionReferencesRequest *nextRequest, NSError *error);

@interface MSGraphServicePrincipalMemberOfCollectionReferencesRequest : MSCollectionRequest

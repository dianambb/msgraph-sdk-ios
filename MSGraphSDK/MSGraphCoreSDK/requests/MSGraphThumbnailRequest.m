...
@implementation MSGraphThumbnailRequest
...
- (NSMutableURLRequest *)update:(MSGraphThumbnail *)thumbnail
{
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:thumbnail]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphThumbnail alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

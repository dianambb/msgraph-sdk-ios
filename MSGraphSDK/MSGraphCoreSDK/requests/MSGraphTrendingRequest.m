...
@implementation MSGraphTrendingRequest
...
- (NSMutableURLRequest *)update:(MSGraphTrending *)trending
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[trending dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:trending]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTrending alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

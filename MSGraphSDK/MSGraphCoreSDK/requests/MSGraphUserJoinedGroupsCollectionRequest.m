...
@implementation MSGraphUserJoinedGroupsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserJoinedGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserJoinedGroupsCollectionRequest *nextRequest = [[MSGraphUserJoinedGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];

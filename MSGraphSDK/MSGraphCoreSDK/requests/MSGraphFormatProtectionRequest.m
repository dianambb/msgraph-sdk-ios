...
@implementation MSGraphFormatProtectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphFormatProtection *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphFormatProtection alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:formatProtection]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphFormatProtection alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

...
@implementation MSGraphBindingRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphBinding *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphBinding alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:binding]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphBinding alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

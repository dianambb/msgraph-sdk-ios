...
@implementation MSGraphOutlookItemRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphOutlookItem *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOutlookItem alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:outlookItem]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOutlookItem alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

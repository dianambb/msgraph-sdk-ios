...
@implementation MSGraphApplicationsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphApplicationsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphApplicationsCollectionRequest *nextRequest = [[MSGraphApplicationsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[application dictionaryFromItem]
                                                   options:0
                                                     error:nil];

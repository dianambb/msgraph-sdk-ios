...
@implementation MSGraphOfficeGraphInsightsRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphOfficeGraphInsights *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOfficeGraphInsights alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:officeGraphInsights]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOfficeGraphInsights alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

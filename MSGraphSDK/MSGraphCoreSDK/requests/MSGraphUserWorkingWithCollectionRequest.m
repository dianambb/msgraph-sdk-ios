...
@implementation MSGraphUserWorkingWithCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserWorkingWithCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserWorkingWithCollectionRequest *nextRequest = [[MSGraphUserWorkingWithCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];

...
@implementation MSGraphPlansCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPlansCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPlansCollectionRequest *nextRequest = [[MSGraphPlansCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[plan dictionaryFromItem]
                                                   options:0
                                                     error:nil];

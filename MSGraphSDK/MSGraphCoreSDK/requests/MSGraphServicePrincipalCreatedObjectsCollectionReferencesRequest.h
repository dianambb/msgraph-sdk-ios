...
typedef void (^MSGraphServicePrincipalCreatedObjectsCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphServicePrincipalCreatedObjectsCollectionReferencesRequest *nextRequest, NSError *error);

@interface MSGraphServicePrincipalCreatedObjectsCollectionReferencesRequest : MSCollectionRequest

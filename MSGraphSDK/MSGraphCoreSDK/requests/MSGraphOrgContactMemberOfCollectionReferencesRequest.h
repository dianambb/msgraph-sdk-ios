...
typedef void (^MSGraphOrgContactMemberOfCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphOrgContactMemberOfCollectionReferencesRequest *nextRequest, NSError *error);

@interface MSGraphOrgContactMemberOfCollectionReferencesRequest : MSCollectionRequest

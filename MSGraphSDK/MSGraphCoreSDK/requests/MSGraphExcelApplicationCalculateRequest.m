...
@interface MSGraphExcelApplicationCalculateRequest()
...
@implementation MSGraphExcelApplicationCalculateRequest
...
{
    NSParameterAssert(calculationType);
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:_calculationType],@"calculationType",nil];

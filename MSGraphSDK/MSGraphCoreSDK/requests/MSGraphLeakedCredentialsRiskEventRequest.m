...
@implementation MSGraphLeakedCredentialsRiskEventRequest
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:leakedCredentialsRiskEvent]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphLeakedCredentialsRiskEvent alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

...
@implementation MSGraphMultiValueLegacyExtendedPropertyRequest
...
- (NSMutableURLRequest *)update:(MSGraphMultiValueLegacyExtendedProperty *)multiValueLegacyExtendedProperty
{    
    NSData *body = [NSJSONSerialization dataWithJSONObject:[multiValueLegacyExtendedProperty dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:multiValueLegacyExtendedProperty]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphMultiValueLegacyExtendedProperty alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

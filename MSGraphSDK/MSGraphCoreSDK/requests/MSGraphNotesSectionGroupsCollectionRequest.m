...
@implementation MSGraphNotesSectionGroupsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphNotesSectionGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphNotesSectionGroupsCollectionRequest *nextRequest = [[MSGraphNotesSectionGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];

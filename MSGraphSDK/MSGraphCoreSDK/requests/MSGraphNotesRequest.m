...
@implementation MSGraphNotesRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphNotes *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphNotes alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:notes]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphNotes alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

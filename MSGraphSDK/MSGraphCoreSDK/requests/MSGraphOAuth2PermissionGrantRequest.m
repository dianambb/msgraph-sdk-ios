...
@implementation MSGraphOAuth2PermissionGrantRequest
...
- (NSMutableURLRequest *)update:(MSGraphOAuth2PermissionGrant *)oAuth2PermissionGrant
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[oAuth2PermissionGrant dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:oAuth2PermissionGrant]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphOAuth2PermissionGrant alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

...
@implementation MSGraphNotesOperationRequest
...
- (NSMutableURLRequest *)update:(MSGraphNotesOperation *)notesOperation
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[notesOperation dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:notesOperation]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphNotesOperation alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

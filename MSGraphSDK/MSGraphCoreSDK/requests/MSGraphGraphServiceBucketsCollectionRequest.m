...
@implementation MSGraphBucketsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphBucketsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphBucketsCollectionRequest *nextRequest = [[MSGraphBucketsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[bucket dictionaryFromItem]
                                                   options:0
                                                     error:nil];

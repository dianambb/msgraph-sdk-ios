...
@implementation MSGraphPersonRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphPerson *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphPerson alloc] initWithDictionary:response];
                                        }
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:person]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphPerson alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

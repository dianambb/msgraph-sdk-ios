...
@implementation MSGraphExtensionPropertyRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphExtensionProperty *response, NSError *error))completionHandler
{
...
- (MSURLSessionDataTask *)update:(MSGraphExtensionProperty *)extensionProperty withCompletion:(void (^)(MSGraphExtensionProperty *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:extensionProperty]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphExtensionProperty alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

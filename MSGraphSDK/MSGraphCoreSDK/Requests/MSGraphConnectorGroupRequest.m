...
@implementation MSGraphConnectorGroupRequest
...
- (NSMutableURLRequest *)update:(MSGraphConnectorGroup *)connectorGroup
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[connectorGroup dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:connectorGroup]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphConnectorGroup alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

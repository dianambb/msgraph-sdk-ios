...
@implementation MSGraphServicePrincipalPoliciesCollectionWithReferencesRequestBuilder : MSCollectionRequestBuilder
...
{
    return [[MSGraphServicePrincipalPoliciesCollectionWithReferencesRequest alloc] initWithURL:self.requestURL options:options client:self.client];
}
...
{
    return [[MSGraphServicePrincipalPoliciesCollectionReferencesRequestBuilder alloc] initWithURL:[self.requestURL URLByAppendingPathComponent:@"$ref"] client:self.client];
}

...
@implementation MSGraphDirectoryRoleScopedAdministratorsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDirectoryRoleScopedAdministratorsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDirectoryRoleScopedAdministratorsCollectionRequest *nextRequest = [[MSGraphDirectoryRoleScopedAdministratorsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];

...
@implementation MSGraphScopedRoleMembershipsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphScopedRoleMembershipsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphScopedRoleMembershipsCollectionRequest *nextRequest = [[MSGraphScopedRoleMembershipsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];

...
@implementation MSGraphEventMessageRequestRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphEventMessageRequest *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEventMessageRequest alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphEventMessageRequest *)eventMessageRequest
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[eventMessageRequest dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:eventMessageRequest]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEventMessageRequest alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

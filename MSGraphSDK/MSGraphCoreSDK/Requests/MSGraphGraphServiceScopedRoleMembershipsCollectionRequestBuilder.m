...
@implementation MSGraphScopedRoleMembershipsCollectionRequestBuilder : MSCollectionRequestBuilder
...
{
    return [[MSGraphScopedRoleMembershipsCollectionRequest alloc] initWithURL:self.requestURL options:options client:self.client];
}

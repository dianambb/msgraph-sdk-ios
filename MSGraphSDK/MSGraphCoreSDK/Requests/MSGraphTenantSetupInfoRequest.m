...
@implementation MSGraphTenantSetupInfoRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphTenantSetupInfo *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTenantSetupInfo alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphTenantSetupInfo *)tenantSetupInfo
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[tenantSetupInfo dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:tenantSetupInfo]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTenantSetupInfo alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

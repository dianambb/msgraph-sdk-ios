...
typedef void (^MSGraphApplicationPoliciesCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphApplicationPoliciesCollectionReferencesRequest *nextRequest, NSError *error);

@interface MSGraphApplicationPoliciesCollectionReferencesRequest : MSCollectionRequest

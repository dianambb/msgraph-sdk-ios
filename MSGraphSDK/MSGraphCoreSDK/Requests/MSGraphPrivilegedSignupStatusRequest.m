...
@implementation MSGraphPrivilegedSignupStatusRequest
...
- (NSMutableURLRequest *)update:(MSGraphPrivilegedSignupStatus *)privilegedSignupStatus
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[privilegedSignupStatus dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:privilegedSignupStatus]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphPrivilegedSignupStatus alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

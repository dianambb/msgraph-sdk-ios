...
@interface MSGraphEventForwardRequestBuilder()
...
@implementation MSGraphEventForwardRequestBuilder
...
- (MSGraphEventForwardRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[MSGraphEventForwardRequest alloc] initWithComment:self.comment

...
@implementation MSGraphConnectorsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphConnectorsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphConnectorsCollectionRequest *nextRequest = [[MSGraphConnectorsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[connector dictionaryFromItem]
                                                   options:0
                                                     error:nil];

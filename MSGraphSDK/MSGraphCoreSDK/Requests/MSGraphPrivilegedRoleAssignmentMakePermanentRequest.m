...
@interface MSGraphPrivilegedRoleAssignmentMakePermanentRequest()
...
@implementation MSGraphPrivilegedRoleAssignmentMakePermanentRequest
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:_reason],@"reason",[MSObject getNSJsonSerializationCompatibleValue:_ticketNumber],@"ticketNumber",[MSObject getNSJsonSerializationCompatibleValue:_ticketSystem],@"ticketSystem",nil];

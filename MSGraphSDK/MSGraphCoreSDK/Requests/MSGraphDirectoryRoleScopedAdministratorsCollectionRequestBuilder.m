...
@implementation MSGraphDirectoryRoleScopedAdministratorsCollectionRequestBuilder : MSCollectionRequestBuilder
...
{
    return [[MSGraphDirectoryRoleScopedAdministratorsCollectionRequest alloc] initWithURL:self.requestURL options:options client:self.client];
}

...
@implementation MSGraphPrivilegedOperationEventRequest
...
- (NSMutableURLRequest *)update:(MSGraphPrivilegedOperationEvent *)privilegedOperationEvent
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[privilegedOperationEvent dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:privilegedOperationEvent]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphPrivilegedOperationEvent alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

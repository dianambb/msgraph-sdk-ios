...
@implementation MSGraphAdministrativeUnitRequest
...
- (NSMutableURLRequest *)update:(MSGraphAdministrativeUnit *)administrativeUnit
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[administrativeUnit dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:administrativeUnit]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphAdministrativeUnit alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];

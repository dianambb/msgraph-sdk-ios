...
@implementation MSGraphUserScopedAdministratorOfCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserScopedAdministratorOfCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserScopedAdministratorOfCollectionRequest *nextRequest = [[MSGraphUserScopedAdministratorOfCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];

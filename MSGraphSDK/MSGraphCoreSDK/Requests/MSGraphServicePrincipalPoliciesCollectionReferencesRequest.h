...
typedef void (^MSGraphServicePrincipalPoliciesCollectionReferencesCompletionHandler)(MSCollection *response, MSGraphServicePrincipalPoliciesCollectionReferencesRequest *nextRequest, NSError *error);

@interface MSGraphServicePrincipalPoliciesCollectionReferencesRequest : MSCollectionRequest

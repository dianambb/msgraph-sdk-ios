...
@implementation MSGraphPrivilegedRoleAssignmentsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPrivilegedRoleAssignmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPrivilegedRoleAssignmentsCollectionRequest *nextRequest = [[MSGraphPrivilegedRoleAssignmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink options:nil client:self.client];
...
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[privilegedRoleAssignment dictionaryFromItem]
                                                   options:0
                                                     error:nil];
